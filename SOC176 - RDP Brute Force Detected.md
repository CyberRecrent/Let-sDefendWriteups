...
На скриншоте мы видим, что на VirusTotal этот адрес помесен как подозрительный, вредоносный и в коментариях указывают на многократные попытки подключения через ssh, похоже на брут форс.  
...
Вердикт: True Positive. Нужно изолировать хост Мэтью. Экслакация на 2 уровень - активный взлом  
